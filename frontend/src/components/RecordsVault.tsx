...
import { FileText, Upload, Share2, Lock } from 'lucide-react';

export default function RecordsVault() {
  const records = [
    { id: 1, name: "Radiology_Chest_XRay.pdf", date: "2026-03-12", type: "Imaging" },
    { id: 2, name: "Immunization_Card_2026.pdf", date: "2026-01-05", type: "Vaccination" },
  ];
