...
export default function PatientAppointmentsDashboard() {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#050914] text-slate-100 font-sans selection:bg-blue-600 selection:text-white relative">
      <PatientSidebar />

      <main className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full space-y-6 pb-24 md:pb-8">
