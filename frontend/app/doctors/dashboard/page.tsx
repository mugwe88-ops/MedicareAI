          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-base font-black text-slate-900">Clinical AI Voice Assistant</h3>
              </div>
              <button 
            ...
            <p className="text-xs text-slate-600">
              Record or dictate patient consultation notes. The AI assistant will automatically transcribe and format e-prescriptions and clinical summaries.
            </p>

            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 min-h-[120px] text-xs text-slate-800 font-medium">
              {aiNotesText || (isRecordingVoice ? "Listening to clinical dictation..." : "Click 'Start Voice Dictation' below to begin recording...")}
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              >
                <Mic size={15} />
                <span>{isRecordingVoice ? "Stop Recording" : "Start Voice Dictation"}</span>
              </button>
