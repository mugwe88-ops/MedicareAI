  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Configure your active practice hours visible to patients during booking.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-slate-100">
          <div>
            ...
            <p className="text-xs text-slate-500">Choose between specific calendar dates or repeating weekly days.</p>
          </div>
