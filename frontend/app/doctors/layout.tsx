"use client";
import { LayoutDashboard, Video, Calendar, Settings, Bell } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-[#0B132B] text-white flex flex-col justify-between hidden md:flex">
        ...
        <div className="p-4 border-t border-gray-800 m-4 bg-gray-900/50 rounded-xl flex items-center space-x-3">
